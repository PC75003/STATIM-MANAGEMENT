...
const SERVICES_FR = {
  ...
  "conseil-rh": {
    ...
    eyebrow: "Solutions RH",
    metaTitle: "Conseil RH : droit du travail et relations sociales",
    metaDesc:
  ...
  "entretiens-professionnels": {
    ...
    eyebrow: "Solutions RH",
    metaTitle: "Entretien de parcours professionnel : externalisation (réforme appliquée)",
    metaDesc:
...
const SERVICES_EN = {
  ...
  "conseil-rh": {
    ...
    eyebrow: "HR Solutions",
    metaTitle: "HR Advisory: employment law and employee relations",
    metaDesc:
  ...
  "entretiens-professionnels": {
    ...
    eyebrow: "HR Solutions",
    metaTitle: "Career development reviews: outsourcing (reform applied)",
    metaDesc:
